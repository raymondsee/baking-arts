$(function(){
    ...
    /*
     * Animate scroll down to the sepectific section.
     */
    $(".desktop-header nav ul li a, .navbar ul.nav li a").on("click", function(){
        var sectionId = $(this).attr("href");
        var sectionTop = $(sectionId).position().top;
...
jQuery(document).ready(function ($) {
    ...
    if ($("#slider2_container").length > 0) {
        ...
        function ScaleSlider() {
            ...
            if (parentWidth)
                jssor_slider2.$ScaleWidth(Math.min(parentWidth-30, 450));
            else
                window.setTimeout(ScaleSlider, 30);
        }
        //ScaleSlider();
...
jQuery(document).ready(function ($) {
    ...
    if ($("#slider3_container").length > 0) {
        ...
        function ScaleSlider() {
            ...
            if (parentWidth)
                jssor_slider3.$ScaleWidth(Math.min(parentWidth-30, 450));
            else
                window.setTimeout(ScaleSlider, 30);
        }
        ScaleSlider();
